...
INSERT INTO robot (id, cat_id, price, name , description) VALUES(1, 1, 84.99, 'Makeblock mBot v1.1 Blue STEM Educational Programmable Robot (Bluetooth)', 'description');
...
INSERT INTO robot (id, cat_id, price, name , description) VALUES(2, 1, 139.99, 'Sphero Star Wars BB-8 Bluetooth Smartphone Controlled Robotic Ball', 'description');
